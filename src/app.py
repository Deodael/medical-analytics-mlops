...
# 1. Build interactive UI entry forms
...
# 2. Package the inputs into a clean structured dictionary payload
payload = {
    "age": age,
    "bmi": bmi,
...
BACKEND_URL = f"{BASE_URL}/predict"
            ...
            if response.status_code == 200:
                ...
                # 4. Present the analysis dynamically based on the model return value
